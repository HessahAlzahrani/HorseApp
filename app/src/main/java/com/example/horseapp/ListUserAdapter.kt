...
class ListUserAdapter(var context: Context) :
    ListAdapter<HorsesDataModel, ListUserAdapter.ResultsItemViewHolder>(DiffCallback) {
...
//        }
        ...
        holder.binding.horsesItemCard.setOnClickListener{
            ...
            val actionForNafigatArgument =
                //from -> to :
                MyListFragmentUserDirections.actionMyListFragmentUserToDetailsPromotionFragment(
